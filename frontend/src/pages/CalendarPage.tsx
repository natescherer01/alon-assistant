  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#F5F5F7' }}>
      ...
      <nav style={{
        ...
        {isMobile && mobileMenuOpen && (
          <div style={{
            ...
            <button
              onClick={() => { setIsTodaysPlanExpanded(!isTodaysPlanExpanded); setMobileMenuOpen(false); }}
              style={{
                padding: '12px 16px',
                fontSize: '15px',
                fontWeight: '500',
      ...
      <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
        ...
        {/* Right Sidebar - Today's Plan Panel (hidden on mobile, accessible via menu) */}
        {!isLoading && calendars.length > 0 && !isMobile && (
          <TodaysPlanPanel
        ...
        <main style={{
          ...
          marginRight: isMobile ? '0' : (!isLoading && calendars.length > 0 ? (isTodaysPlanExpanded ? '320px' : '48px') : '0'),
